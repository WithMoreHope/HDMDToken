...
contract HDMDToken is ERC20,PoSTokenStandard, Ownable {
    ...
    modifier canPoSMint() {
        // condition to determine how much can be minted
        // this should be the amount of DMD staked
        // TODO: have process to sync changes with DMD
        _;
    }
    ...
    function mint(uint256 _reward) canPoSMint public returns (bool) {
